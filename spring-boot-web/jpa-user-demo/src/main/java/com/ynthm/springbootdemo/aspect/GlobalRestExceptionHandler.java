...
/** Author : Ynthm https://www.baeldung.com/global-error-handler-in-a-spring-rest-api */
...
public class GlobalRestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected ResponseEntity<Object> handleMethodArgumentNotValid(
    ...
    return handleExceptionInternal(ex, apiResult, headers, status, request);
  }
  ...
  /**
   * 必须配置生效 spring.mvc.throw-exception-if-no-handler-found=true spring.resources.add-mappings=false
   *
   * @param ex
   * @param headers
   * @param status
  ...
  public ResponseEntity<Object> handleAll(Exception ex) {
    ApiResult<String> apiResult = new ApiResult<>();
    apiResult.setData(ex.getLocalizedMessage());
    return new ResponseEntity<>(apiResult, HttpHeaders.EMPTY, HttpStatus.INTERNAL_SERVER_ERROR);
  }
}
