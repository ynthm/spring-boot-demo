package com.ynthm.demo.mybatis.plus.user.controller;
...
import com.ynthm.demo.mybatis.plus.enums.CaptchaScopeEnum;
import com.ynthm.demo.mybatis.plus.user.request.*;
...
public class UserController {
  ...
  public Result<String> register(
      ...
      throws Exception {
    request.setIp(ServletUtil.getIpAddress(httpServletRequest));
